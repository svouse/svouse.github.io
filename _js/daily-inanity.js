document.addEventListener("DOMContentLoaded", function() {
    const dailyEntries = [
        ...
        {date: "2025-03-12", image: "/assets/images/metal_door.png", text: "I find myself grateful for the sinking arm, and for the company of my friends, and for good dinner. If I can no longer feed the conglomerate bloom with my tears, nor shout into it, nor beat against its movement with my fists, I may reasonably present it with food, make no pretense, and try to rest. I may, if I’m lucky, sit with it in silence."}
    ];
